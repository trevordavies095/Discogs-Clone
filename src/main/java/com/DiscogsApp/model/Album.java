...
public class Album implements SearchObject
{
    ...
    public boolean equals(Object o)
    {
        ...
        if (rating != album.rating)
            return false;
        if (barcode != null ? !barcode.equals(album.barcode) : album.barcode != null)
            return false;
        if (style != null ? !style.equals(album.style) : album.style != null)
            return false;
        if (genre != null ? !genre.equals(album.genre) : album.genre != null)
            return false;
